...
class ProDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        contactmap_np = pickle.load(open(contactMapFile, "rb"))
        contactMap = np.expand_dims(contactmap_np, axis=0)
...
testFoldPath = './data/Fragalysis/dataPre/Fragalysis-test'
trainFoldPath = './data/Fragalysis/dataPre/Fragalysis-train'
contactPath = './data/Fragalysis/contactMap'
contactDictPath = './data/Fragalysis/dataPre/Fragalysis-contactDict'
smileLettersPath  = './data/Fragalysis/voc/combinedVoc-wholeFour.voc'
seqLettersPath = './data/Fragalysis/voc/sequence.voc'
...
trainArgs['saveNamePre'] = 'Fragalysis'
